    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                ...
                : message == ManageMessageId.RemovedVisitors ? "Usunięto listę odwiedzających strone!"
                : message == ManageMessageId.RemovedMailers ? "Usunięto listę osób które wysłały maila!"
                : "";
            ...
            using(var db = new ApplicationDbContext())
            {
                ...
                model.FaceViews = db.Faces.Select(x => x.Counter).FirstOrDefault().ToString();
            }
            return View(model);
        }
